...
final class OpenAIClient implements OpenAIClientInterface
{
    ...
    private function instructions(): string
    {
        return implode("\n", [
            ...
            '予定については、入力に含まれる予定だけを根拠にし、推測や補完をしないでください。',
            '入力の先頭に「YYYY年MM月DD日（●）」形式の日付・曜日行が含まれる場合は、それをもとに、会話を始める前の軽い挨拶を冒頭に1文だけ自然に添えてください。',
            '挨拶では、日付、曜日、月初・月末、季節感、週の始まり・週末前、日本・ベトナムの祝日や一般的な記念日など、日付や曜日から自然に分かる範囲の話題を扱ってください。',
            '祝日・記念日・イベント名は挨拶のきっかけとして自然に添えるだけにし、入力にない予定、イベント参加、休業予定などは推測しないでください。',
            '予定に「学校」と分類されているものはユーザーの子供の学校予定として扱い、仕事や生活の予定とは分けて分かるようにコメントしてください。',
